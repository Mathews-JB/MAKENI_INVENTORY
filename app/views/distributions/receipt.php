...
<head>
    ...
    <title>Distribution Slip #<?php echo $data['order']->order_number ?? ''; ?></title>
...
<body class="bg-gray-100 min-h-screen py-8">
    ...
    <div class="max-w-xl mx-auto mb-6 flex justify-between items-center no-print px-4 md:px-0">
        <a href="<?php echo URL_ROOT; ?>/distributions" class="flex items-center text-gray-600 hover:text-gray-900 transition">
    ...
    <div class="print-container max-w-xl mx-auto bg-white shadow-2xl rounded-xl overflow-hidden">
        ...
        <div class="p-8 md:p-12">
            <div class="flex justify-between items-start mb-12">
                ...
                <div class="w-1/2">
                    ...
                    <?php else: ?>
                        ...
                        <h1 class="text-2xl font-bold text-gray-900"><?php echo $school_display; ?></h1>
                    <?php endif; ?>
                ...
                <div class="text-right">
                    <h2 class="text-4xl font-bold text-gray-200 tracking-tight mb-1">DISTRIBUTION</h2>
                    ...
                    <div class="space-y-2 text-sm bg-gray-50 p-4 rounded-lg border border-gray-100">
                        ...
                        <div class="flex justify-between gap-4 text-gray-600 pt-2 border-t border-dashed border-gray-200 mt-2">
                             <span class="font-medium text-gray-500">Allocation:</span>
            ...
            <div class="mb-12 bg-gray-50 rounded-lg p-6 border border-gray-100">
                <h3 class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4">Allocate To</h3>
                <div class="flex flex-wrap gap-8">
                    <div>
                        <p class="font-bold text-gray-900 text-lg"><?php echo $order->recipient_name; ?></p>
                        <?php if ($order->recipient_email): ?>
                            <p class="text-sm text-gray-600 mt-1"><?php echo $order->recipient_email; ?></p>
                        <?php endif; ?>
                        <?php if ($order->recipient_phone): ?>
                            <p class="text-sm text-gray-600 mt-1"><?php echo $order->recipient_phone; ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                    ...
                    <tbody class="divide-y divide-dashed divide-gray-200">
                        ...
                        <tr>
                            <td class="py-4 px-4 align-top">
                                ...
                                <p class="text-xs text-gray-500 mt-1 font-mono">SKU: <?php echo $item->material_sku ?? 'N/A'; ?></p>
                            </td>
                ...
                <div class="w-full md:w-5/12">
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center text-gray-900">
                            <span class="text-base font-bold text-gray-800">Grand Total Value</span>
            ...
            <div class="mt-16 pt-8 border-t border-gray-100 text-center">
                <h4 class="font-bold text-gray-900 text-sm mb-2">Thank you for using MAKENI ISLAMIC INVENTORY!</h4>
                <p class="text-gray-500 text-xs">For any inquiries regarding this distribution, please contact the administration office.</p>
    ...
    <div class="max-w-md mx-auto mt-20 p-8 bg-white rounded-xl shadow-lg text-center">
        ...
        <h3 class="text-lg font-bold text-gray-900 mb-2">Distribution Slip Not Found</h3>
        <p class="text-gray-500 mb-6 text-sm">The distribution slip you requested could not be found.</p>
        <a href="<?php echo URL_ROOT; ?>/distributions" class="inline-block bg-gray-900 text-white px-6 py-2 rounded-lg text-sm hover:bg-gray-800 transition">Back to Distributions</a>
    </div>
    <?php endif; ?>
</body>
</html>
